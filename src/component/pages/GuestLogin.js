  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://guest-mangement-backend.onrender.com/app/guest-receive"
      );
      ...
      if (response.ok) {
        ...
        if (user) {
          ...
          const updateResponse = await fetch(
            `https://guest-mangement-backend.onrender.com/app/guest-updatesingle/${email}/${game}`,
            {
              method: "PUT",
              headers: {
            ...
            <div className="card bg-glass mt-4">
              <div className="card-body px-4 py-5 px-md-5">
                <form onSubmit={handleSubmit}>
                  <div className="container align-item-center d-flex justify-content-start p-0">
                    <h4 style={{ color: "#00ACC1" }}>GUEST LOGIN</h4>
                  </div>
